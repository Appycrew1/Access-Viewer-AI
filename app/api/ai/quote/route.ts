...
export async function POST(req:Request){
  ...
  "terms": [
    ...
    "Rescheduling allowed 48h notice"
  ],
  "email_subject": "Your moving quote from Battersea Movers",
  "email_body": "Hi {first_name},\\n\\nThanks for considering us! Based on your details, your quote is \u00a3420..."
}
  if(!OPENAI_API_KEY) return NextResponse.json({ source:'mock', ...mock })
  const sys = `You are an expert operations assistant for a London moving company. Return STRICT JSON for the quote task.`
