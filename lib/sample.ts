  ...
  addresses: [
    {
      ...
      access: {
        driveway: false, stairs_visible: true, double_yellow: true, red_route: false, narrow_road: true, parking_zone: 'CPZ A (mock)',
    ...
    },
    {
      ...
      access: {
        driveway: false, stairs_visible: true, double_yellow: false, red_route: false, narrow_road: false, parking_zone: 'CPZ B (mock)',
    ...
    },
    {
      ...
      access: {
        driveway: true, stairs_visible: false, double_yellow: false, red_route: false, narrow_road: false, parking_zone: 'Private access (mock)',
